...
if($_POST['Delete'] == 'Delete Selected'){
	...
	if($arr_num > 0){
		...
		while($fetch_s = mysql_fetch_assoc($exec_s)){
			...
			@unlink('../pics/'.$fetch_s[image2]);
			//@unlink('../thumb/'.$fetch_s[thumb]);
		}
...
//	@unlink('../thumb/'.$fetch['thumb']);
	@unlink('../pics/'.$fetch['image2']);
...
<div align="center">
  <div class="container">
    ...
    <div class="content">
      ...
      <div class="head"> <span class="head_text">Images</span>
        <div class="add"> <a href="<?php echo $page_child; ?>?cust_img=<?php echo $_GET['cust_img'];?>"> <span class="add1"> <span class="head_text1"> <?php echo $item; ?></span> </span> </a> </div>
...
-->              <td align="center" width="20%"> Displayed </td>
            ...
            <tr class="scndrow <?php echo $z%2 ? '' : 'alternate';?>">
              ...
              <td><div class="nn3"> <img src='<?php if($fetch['image']<> ''){echo '../pics/'.$fetch['image'];}else{echo 'images/1.png';} ?>' alt="images/image" height="100" width="200" /> </div></td>

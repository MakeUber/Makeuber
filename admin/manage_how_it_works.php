...
$item = 'Works';				// table name for query
$page_child = 'add_edit_how_it_works.php';				// table name for query
...
<!--               <td align="left"><div class="n_1"><?php echo $fetch['title']; ?></div></td>
             <td align="left"><div class="n_1"><?php //echo substr($fetch['description'],0,30);?>...</div></td>

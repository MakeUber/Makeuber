   ...
   var tool = $('#tool').val();
    ...
    if(title == '') {
		...
		$('#desc').focus();
  		...
  		var error = "Error:Please Enter tools used";
		$('#tool').focus();
    } 
      ...
      <div class="form5">
        <form id="add" name="add" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>?5=5<?php echo $q_string; ?>" enctype="multipart/form-data" onsubmit="return check_validation();">
          <table width="100%" border="0" cellpadding="5">
            <tr> <td></td>
              <td><div id="error" style="color:#F00; margin-left:0px; "></div></td>
            </tr>
            
            <tr>
              <td align="right" class="label_form" style="width:290px;">Title: </td>
            ...
            <tr>
              ...
              <td><div style="border:1px solid red;">
                  <textarea   name="description[]" class="edit2"><?php echo $fetch_field['description'];?> </textarea><div class="clear"></div>
                </div> </td>
            </tr>
            <?php $i++;} } else{?>
            <tr>
              ...
              <td>
                  <div style="float:left;"><input id="location" name="pic[]"  type="file"  /></div>
                  <div style="float:left;">Description : &nbsp;</div>
                  <div style="float:left;"><textarea  id="description" name="description[]" class="edit2"></textarea> <div class="clear"></div></div>
              </td>
            </tr>
           <?php }?>
           
            <tr>
              <td class="label_form" style="margin-left:190px"><div id="dynamicInput" style="width:400px; margin-left: -113px;border:1px solid red;height: 80px; "> 
              ...
              <td class="label_form" style="margin-left:190px">
              
              <div id="dynamicInput1" style="width:400px; margin-left: 229px;border:1px solid red;width: 251px; height: 80px;"> 
                  <script language="javascript">
                <?php if($_GET['do'] == 'edit'){ ?>
                            var counter1 = <?php echo $j;?>
                <?php } else{ ?>
                            var counter1 = 0 ;
                <?php }  ?>
				...
				function addInput1(divName1){
                 if(counter1 >= limit1){
                  alert("Error: Maximium 10 descriptions can add ");
                 }
                 else{
					 var newdiv1 = document.createElement('div');
					  newdiv1.innerHTML = "<div style='padding-top: 5px;padding-right: 14px;float: left;width: 600px;'>Description" + (counter1 + 1)+":&nbsp;</div>" + "<div style='width: 203px;margin-left: -623px;float: left;'><textarea  name='description[]' id='description' class='edit2' style='margin-left: 114px;margin-top: 15px;'><?php echo $desc ;?></textarea> </div> <br class='clear'>";
           ...
           <?php }?>
            ...
            <tr class="tr_clone">
                  ...
                  <td><input id="tool" name="tool[]" type="text" class="input_text" value=""/>&nbsp;<div>
                  <img style="float:left; cursor:pointer; padding-left:15px;" title="Delete Row" src="images/delete.png" alt="cross" onclick = "if(document.getElementById('table-data').rows.length != 1){$(this).parent().parent().remove(); } else{ alert('sorry, you cannot delete this');}" > </div>
             </tr>
		  ...
		  <?php } else{ $j=1; while($fetch_meta = mysql_fetch_assoc($exec_meta)){
            ...
            <tr class="tr_clone" style="border:1px solid red;">
                  ...
                  <td><input id="tool" name="tool[]" type="text" class="input_text" value="<?php echo $fetch_meta['tool'];?>"/>&nbsp;<div >
                 <a href="<?php echo $_SERVER['PHP_SELF']; ?>?do=edit&go=deletemeta&mid=<?php echo $fetch_meta['id'].'&id='.$id; ?>" ><img style="float:left; cursor:pointer; padding-left:15px;" title="Delete Tool<?php echo $j;?>" src="images/delete.png" alt="cross"></a></div>  </td>
            </tr><?php $j++; } }?>
            <tr>
                <td></td>
                <td></td>
           ...
           <table width="100%" border="0" cellpadding="5">
            <tr>
              <td></td> 
              <td><div class="btn">
                  <input style="margin-left:170px" type="button" name="add" value="Add Step" onClick="addInput('dynamicInput'),addInput1('dynamicInput1');" class="button" >

...
$relation = $_GET['rel'];
if($relation != ''){
	$sql = "SELECT * from $tabl where 1=1 order by sort ASC";
}
else{
...
<ul id="test-list">
	...
	while($fetch1 = mysql_fetch_assoc($exec)){
		echo '<li id="listItem_'.$fetch1[id].'" style="padding:2px;"><img src="images/arrow.png" alt="move" width="16" height="16" class="handle" /> <img src="../img/'.$fetch1[project_image].'" width="30px" height="25px"/></a></li>';
		$i++;
	}

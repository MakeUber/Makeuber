	...
	echo "<img src='images/1.png' />";
	      ...
	      echo "<img src='../img/".$dvar['image']."' width='98px' height='98px'/>"; 
              ...
              <tr>                
                  <td align="right" class="label_form">Name: </td>
                  <td>
                  <select name="image_name" class="input_text">
                   <?php while($fetch_design = mysql_fetch_assoc($exec_design)){?>
		<option value="<?php echo $fetch_design['category_name'];?>"><?php echo $fetch_design['category_name'];?></option>
        <?php }?>
                  </select>
                  <br class="clear" /></td>
              </tr>

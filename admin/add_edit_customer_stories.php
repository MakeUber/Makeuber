...
$page_parent = 'manage_customer_stories.php';
...
if($_GET['do'] == 'edit'){
	...
	$dvar['posted_by'] = $fetch['posted_by'];
...
if($_POST['submitbut'] == 'Save'){
	...
	$dvar['posted_by'] = $_POST['posted_by'];

	if($dvar['title'] == ''){$flag[1] = 'r';}
	if($dvar['description'] == ''){$flag[1] = 'r';}
	if($dvar['posted_by'] == ''){$flag[2] = 'r';}
  ...
  <div class="container">
	...
	echo "<img src='images/1.png' />";
	      ...
	      echo "<img src='../img/".$dvar['image']."' width='98px' height='98px'/>"; 
               ...
               <tr>                
                  <td align="right" class="label_form">Posted By: </td>
                  <td><input name="posted_by" type="text" class="input_text" value="<?php echo $dvar['posted_by'];?>"/><br class="clear" /></td>
              </tr>
               <tr>                
                  <td align="right" class="label_form">Description: </td>
                  <td><textarea name="description" id="description" type="text" class="ckeditor"><?php echo $dvar['description'];?></textarea><br class="clear" /></td>
              </tr>        
           <tr>
                <td>&nbsp;</td>
                <td>

		...
		if(mysql_query($sql)){
			...
			if($_GET['do'] == 'edit'){ 
					...
					$flag_r = 'r';
						...
						if($file == '1'){
						 $thumb =  $path1;
						 $sql_up = "update files set thumb='".'thumb/'.$image_name."',thumb_big='".'thumb_big/'.$image_name."',location='".'file/'.$image_name."', file_name='".'file/'.$image_name."',description='".$desc."' where id='".$fetch['id']."'"; 
        ...
        <form id="add" name="add" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>?5=5<?php echo $q_string; ?>" enctype="multipart/form-data" onsubmit="return check_validation();">
          <table width="100%" border="0" cellpadding="5">
            ...
            <tr>
              ...
              <td><div> <textarea   name="description" class="edit2"><?php echo $fetch_field['description'];?> </textarea> </div></td>
            </tr>
            <?php $i++;} } 
					else{
				   ?>
            ...
            <tr>
              <td align="right" valign="top" class="label_form">Description(<?php echo $i; ?>):</td>
              <td><div>
                  <textarea   name="description" class="edit2"><?php echo $fetch_field['description'];?> </textarea>
                </div></td>
            </tr>
            <?php } ?>
            <tr>
                 ...
                 if(counter >= limit){
                  alert("Error: Maximium 10 images upload ");
                    ...
                    var newdiv = document.createElement('div');
                     newdiv.innerHTML = "
					 <div style='margin-left: 206px;padding-top: 5px;padding-right: 14px;float: left;width: 600px;' >Image" + (counter + 1)+":&nbsp;</div>" + "<div style='width: 203px;margin-left: -623px;float: left;'><input type='file' id='location' name='pic[]' value='<?php echo $dvar['pic']; ?>' class='edit2' style='margin-left: 114px;padding: 10px;'></div> <br class='clear'>";
                 ...
                 if(counter1 >= limit1){
                  alert("Error: Maximium 10 descriptions can upload ");
					 ...
					 var newdiv1 = document.createElement('div1');
					  newdiv1.innerHTML = "<div style='padding-top: 5px;padding-right: 14px;float: left;width: 600px;>Description" + (counter1 + 1)+":&nbsp;</div>" + "<div style='width: 203px;margin-left: -623px;float: left;'><textarea  name='description[]' id='description' class='edit2' style='margin-left: 114px;'><?php echo $description  ;?></textarea> </div> <br class='clear'>";

...
$item = 'Stories';				// table name for query
$page_child = 'add_edit_customer_stories.php';				// table name for query
...
if($_GET['search'] == '' || $_GET['search'] == 'search'){
	...
	$sql1 = "SELECT $select from $from AND $base_tabl.title like '%$search_txt_db%'"; 
}
        ...
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>?1=1<?php echo $q_string_pg; ?>" method="post" name="<?php echo $item; ?>">
          ...
          <table width="100%" cellspacing="0" cellpadding="0"  class="maintbl" >
            <tr class="fstrow"  >
              ...
              <td align="center" width="15%">Manage Images</td>
	...
	echo 'images/1.png';
	      ...
	      echo '../img/'.$fetch["image"].''; 
              ...
              <td align="left"><div class="n_1"><?php echo $fetch['title']; ?></div></td>
                <td align="center"><div class="n_1"> <a href='manage_cust_images.php?cust_img=<?php echo $fetch['id'].$q_string_pg; ?>'>Manage Images</a></div></td>
              ...
              <td align="center">
              <!--	<a style="margin:0px 10px;" href="view_home_page.php?do=view&id=<?php echo $fetch['id'].$q_string_pg; ?>" title="View"> <img src="images/view.png" /> </a>-->

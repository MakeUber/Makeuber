...
$item = 'Price per sq feet';				// table name for query
$page_child = 'add_edit_sq_price.php';				// table name for query
        ...
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>?1=1<?php echo $q_string_pg; ?>" method="post" name="<?php echo $item; ?>">
          ...
          <table width="100%" cellspacing="0" cellpadding="0"  class="maintbl" >
            <tr class="fstrow"  >
              ...
              <td align="left" width="20%">Price</td>
            ...
            <tr class="scndrow <?php echo $z%2 ? '' : 'alternate';?>">
              ...
              <td align="left"><div class="n_1"><?php echo $fetch['per_sq_price']; ?></div></td>
              ...
              <td align="center">
              	<a style="margin:0px 10px;" href="view_sq_price.php?do=view&id=<?php echo $fetch['id'].$q_string_pg; ?>" title="View"> <img src="images/view.png" /> </a>

...
$item = 'Material';				// table name for query
$page_child = 'add_edit_material.php';				// table name for query
    ...
    <div class="content">
      ...
      <div class="down_category" style="margin-top:30px">
        <div class="head"> <span class="head_text"><?php echo $item; ?></span>
          <div class="add"> <a href="<?php echo $page_child; ?>"> <span class="add1"> <span class="head_text1" style="font-size:14px;">Material</span> </span> </a></div>
        ...
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>?1=1<?php echo $q_string_pg; ?>" method="post" name="<?php echo $item; ?>">
          ...
          <table width="100%" cellspacing="0" cellpadding="0"  class="maintbl" >
            ...
            <tr class="scndrow <?php echo $z%2 ? '' : 'alternate';?>">
              ...
              <td align="left"><div class="n_1"><?php echo $fetch['material']; ?></div></td>
              ...
              <td align="center">
              	<a style="margin:0px 10px;" href="view_material.php?do=view&id=<?php echo $fetch['id'].$q_string_pg; ?>" title="View"> <img src="images/view.png" /> </a>

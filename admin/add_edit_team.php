...
if($_GET['do'] == 'edit'){
	...
	$dvar['designation'] = $fetch['designation'];
	$image = $fetch['image'];
	//print_r($fetch);
...
if($_POST['submitbut'] == 'Save'){
	...
	$dvar['designation'] = $_POST['designation'];

	if($dvar['name'] == ''){$flag[1] = 'r';}
	else if($dvar['designation'] == ''){$flag[2] = 'r';}
      ...
      <div class="form5">
        <form id="add" name="add" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>?1=1<?php echo $q_string; ?>" enctype="multipart/form-data">
            <table width="1150" border="0" cellpadding="5">
               ...
               <tr>                
                  <td align="right" class="label_form">Designation: </td>
                  <td><input name="designation" type="text" class="input_text" value="<?php echo $dvar['designation'];?>"/><br class="clear" /></td>
              </tr>    
           <tr>
                <td>&nbsp;</td>
                <td>

      ...
      <div class="viewform">
        <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
         <table width="1150" border="0" cellpadding="5">
          ...
          <tr>
            <td align="right" class="label_form"><div class="view1">Project Name :</div></td>
         	<td><div class="view2"><?php echo $dvar['project_name']; ?></div></td>
         </tr>
         <tr>
            <td align="right" class="label_form"><div class="view1">Project image :</div></td>
         	<td><div class="view2"><img src="../img/<?php echo $dvar['project_image']; ?>" height="200px" width="200px" /></div></td>
         </tr>
         ...
         <tr>
          ...
          <tr>
            <td align="right" class="label_form"><div class="view1">Project Images :</div></td>
         	<td><div class="view2"><a href="manage_project_images.php?id=<?php echo $dvar['id']; ?>">See Images</a></div></td>
         </tr>

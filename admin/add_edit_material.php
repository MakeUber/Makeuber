...
if($_GET['do'] == 'edit'){
	...
	$dvar['material'] = $fetch['material'];
	$dvar['cats_id'] = $fetch['cats_id'];
	//$dvar['category_image'] = $fetch['category_image'];

}

if($_POST['submitbut'] == 'Save'){
	$dvar['material'] = $_POST['material'];
	$dvar['cats_id'] = $_POST['category'];
	 


	if($dvar['material'] == ''){$flag[1] = 'r';}
	else if($dvar['cats_id'] == ''){$flag[82] = 'r';}
...
<div align="center">
  <div class="container">
    ...
    <?php while ($cat_row = mysql_fetch_assoc($cat)) {?>
                    ...
                    <option value="<?php echo $cat_row['id'];?>" <?php if($dvar['cats_id']==$cat_row['id']){ echo "selected='selected'";} ?>><?php echo $cat_row['category_name'];?></option>
                     <?php }?>
    </select>
               ...
               <tr>                
                  <td align="right" class="label_form">Material: </td>
                  <td><input name="material" type="text" class="input_text" value="<?php echo $dvar['material'];?>"/><br class="clear" /></td>
              </tr>

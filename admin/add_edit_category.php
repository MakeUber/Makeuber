...
$tabl = 'category';
$item = 'Category';
$page_parent = 'manage_categories.php';
...
if($_GET['do'] == 'edit'){
	...
	$dvar['category_name'] = $fetch['category_name'];
	$image = $fetch['category_image'];

}

if($_POST['submitbut'] == 'Save'){
	$dvar['category_name'] = $_POST['category_name'];
	
	if($dvar['category_name'] == ''){$flag[1] = 'r';}
        ...
        <form id="add" name="add" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>?1=1<?php echo $q_string; ?>" enctype="multipart/form-data">
            <table width="1150" border="0" cellpadding="5">
               ...
               <tr>                
                  ...
                  <td><input name="category_name" type="text" class="input_text" value="<?php echo $dvar['category_name'];?>"/><br class="clear" /></td>
              </tr>
                  <tr>                
                  ...
                  <td><div class="pic">
                      ...
                      <div class="edit1"><input name="category_image" type="file" /><div class="clear"></div>
                        <span class="edit">

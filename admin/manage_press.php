...
$item = 'Press';				// table name for query
$page_child = 'add_edit_press.php';				// table name for query
        ...
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>?1=1<?php echo $q_string_pg; ?>" method="post" name="<?php echo $item; ?>">
          ...
          <table width="100%" cellspacing="0" cellpadding="0"  class="maintbl" >
            <tr class="fstrow"  >
              ...
              <td align="center" width="30%"> Displayed </td>
            ...
            <tr class="scndrow <?php echo $z%2 ? '' : 'alternate';?>">
              ...
              <td align="left"><div class="n_1"><img src='<?php if($fetch['image']<> ''){echo '../pics/'.$fetch['image'];}else{echo 'images/1.png';} ?>' alt="images/image" height="100" width="200" /> </div></td>

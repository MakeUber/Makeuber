...
$page_parent = 'manage_sq_price.php';
...
if($_POST['submitbut'] == 'Save'){
	$dvar['per_sq_price'] = $_POST['per_sq_price'];
	
	 


	if($dvar['per_sq_price'] == ''){$flag[14] = 'r';}
      ...
      <div class="form5">
        <form id="add" name="add" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>?1=1<?php echo $q_string; ?>" enctype="multipart/form-data">
            <table width="1150" border="0" cellpadding="5">
               ...
               <tr>                
                  <td align="right" class="label_form">Enter Sq Feet Price: </td>
                  <td><input name="per_sq_price" type="text" class="input_text" value="<?php echo $dvar['per_sq_price'];?>"/><br class="clear" /></td>
              </tr>

      ...
      <div class="viewform">
        <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
         <table width="1150" border="0" cellpadding="5">
          ...
          <tr>
            <td align="right" class="label_form"><div class="view1">Blog Name :</div></td>
         	<td><div class="view2"><?php echo $dvar['title']; ?></div></td>
         </tr>
           <tr>
            <td align="right" class="label_form"><div class="view1">Blog image :</div></td>
         	<td><div class="view2">
              <?php if(empty($dvar['image'])){
	echo "<img src='images/1.png' />";
	}else{
	      echo "<img src='../img/".$dvar['image']."' width='200px' height='200px'/>"; 
		  } ?><br />
           </div></td>
         </tr>
         <tr>
       ...
       <tr>
              <td align="right" class="label_form"><div class="view1">Blog Status :</div></td>
              <td><div class="view2">
                  <?php 

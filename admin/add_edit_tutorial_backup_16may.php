		...
		if(mysql_query($sql)){
			...
			if($_GET['do'] == 'edit'){ 
					...
					$flag_r = 'r';
						...
						$sql_up1 = "update files set thumb='".$fetch['thumb']."',thumb_big='".$fetch['thumb_big']."',location='".$fetch['location']."', file_name='".$fetch['file_name']."',description='".$fetch['description']."' where id='".$fetch['id']."'"; 
...
<script src="../js/tutorial_validation.js"></script>
      ...
      <div class="form5">
        <form id="add" name="add" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>?5=5<?php echo $q_string; ?>" enctype="multipart/form-data" onsubmit="return check_validation();">
          <table width="100%" border="0" cellpadding="5">
            ...
            <tr>
              <td align="left" class="label_form" style="text-align:left"><div style="float:left; margin-top:8px; margin-right:8px">Title:</div><div style="float:left"> <input name="title" id="title" type="text" class="input_text" value="<?php echo $dvar['title'];?>"/></div></td>
              <td>
                <br class="clear" /></td>
            </tr>
             <?php
            ...
            <tr>
              ...
              <td><div>
                  <textarea   class="edit2"><?php echo $fetch_field ['description'];?> </textarea>
                </div></td>
            </tr>
            <?php $i++;} } else{?>
            <tr>
              <td align="right" valign="top" class="label_form">
                  <div style="float:left; width:100%; margin-left:43px">
                      <div style="float:left; padding-top:4px">Image:</div>
                      <div style="float:left"><input type="file" /></div>
                  </div> 
              </td>
              <td>
                 <div style="float:left; width:100%">
                      <div style="float:left;padding-top: 23px; padding-right: 19px;">Description:</div>
                      <div style="float:left"><textarea class="edit2"></textarea></div>
                  </div>
              
                  <?php /*?><div style="float:left;"><input  id= "location" name="pic[]" type="file"  /></div>
                  <div style="float:left;">Description : &nbsp;</div>
                  <div style="float:left;"><textarea  id="description" name="description[]" class="edit2"><?php echo $desc ;?></textarea><?php */?></div>
              </td>
            </tr>
        	 <?php }?>
           
            <tr>
              <td class="label_form" style="width:50%" >
              <div  id="dynamicInput" style="margin-top:10px; margin-left:20px">
                  
                 <div style="float:left; width:100%; margin-left:170px">
                 ...
                 if(counter >= limit){
                  alert("Error: Maximium 10 images upload ");
                    ...
                    var newdiv = document.createElement('div');
                     newdiv.innerHTML = "<div style='float:left; padding-top:4px; height:66px' >Image" + (counter + 1)+"</div>" + "<div style='float:left'>&nbsp;&nbsp;&nbsp;&nbsp;<input type='file' id='location'  name='pic[]' value='<?php echo $dvar['pic']; ?>' ></div> <div class='clear'></div> ";
            ...
            <div class="clear"></div>
           <!-- <div style="float:left; padding-top:4px">Image1:</div>
                  <div style="float:left"><input type="file" /></div>
              </div>-->
                </td>
              ...
              <div id="dynamicInput1" style="margin-top:10px">
                <div  style="float:left; width:100%; ">
                 ...
                 if(counter1 >= limit1){
                  alert("Error: Maximium 10 descriptions can upload ");
					 ...
					 var newdiv1 = document.createElement('div');
					  newdiv1.innerHTML = "<div style='float:left; padding-top: 23px;'>Description" + (counter1 + 1)+":&nbsp;" + "</div><div style='float:left'><textarea  name='description[]' id='description' class='edit2' ></textarea></div> <div class='clear'></div>";
          ...
          <table id="table-data"  width="100%" border="0" cellpadding="5">
            <?php if($_GET['do'] != 'edit' || $num == 0){ ?>
            <tr class="tr_clone">
              <td align="right" class="label_form" style="width:290px;">Tool Used :</td>
              <td><input id="tool" name="tool[]" type="text" class="input_text" value=""/>
                &nbsp;
                <div> <img style="float:left; cursor:pointer; padding-left:15px;" title="Delete Row" src="images/delete.png" alt="cross" onclick = "if(document.getElementById('table-data').rows.length != 1){$(this).parent().parent().remove(); } else{ alert('sorry, you cannot delete this');}" > </div>
            </tr>
            ...
            <tr class="tr_clone" style="border:1px solid red;">
              <td align="right" class="label_form" style="width:290px;">Tool Used(<?php echo $j;?>):</td>
              <td><input id="tool" name="tool[]" type="text" class="input_text" value="<?php echo $fetch_meta['tool'];?>"/>
                &nbsp;
                <div > <a href="<?php echo $_SERVER['PHP_SELF']; ?>?do=edit&go=deletemeta&mid=<?php echo $fetch_meta['id'].'&id='.$id; ?>" ><img style="float:left; cursor:pointer; padding-left:15px;" title="Delete Tool" src="images/delete.png" alt="cross"></a></div></td>
            </tr>
            <?php $j++; } }?>
            <tr>
              <td></td>

...
$item = 'Membership';				// table name for query
$page_child = 'add_edit_membership.php';				// table name for query
...
if($_GET['search'] == '' || $_GET['search'] == 'search'){
	...
	$sql1 = "SELECT $select from $from AND $base_tabl.type like '%$search_txt_db%' or $base_tabl.budget like '%$search_txt_db%'"; 
}
  ...
  <div class="container">
        ...
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>?1=1<?php echo $q_string_pg; ?>" method="post" name="<?php echo $item; ?>">
          ...
          <table width="100%" cellspacing="0" cellpadding="0"  class="maintbl" >
            <tr class="fstrow"  >
              ...
              <td align="center" width="15%"> Budget </td>
	...
	echo 'images/1.png';
	      ...
	      echo '../img/'.$fetch["image"].''; 
              ...
              <td align="left"><div class="n_1"><?php echo $fetch['type']; ?></div></td>
              <td align="center"><div class="n_1"><?php echo $fetch['budget']; ?></div></td>
              ...
              <td align="center">
              	<a style="margin:0px 10px;" href="view_membership.php?do=view&id=<?php echo $fetch['id'].$q_string_pg; ?>" title="View"> <img src="images/view.png" /> </a>

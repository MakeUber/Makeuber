		...
		if(mysql_query($sql)){
			...
			if($_GET['do'] == 'edit'){ 
					...
					$flag_r = 'r';
						...
						if($file == '1'){
						 $thumb =  $path1;
						 $sql_up = "update files set thumb='".'thumb/'.$image_name."',thumb_big='".'thumb_big/'.$image_name."',location='".'file/'.$image_name."', file_name='".'file/'.$image_name."' where id='".$fetch['id']."'"; 
						...
						if($file <> '1'){//if no changes the fetch data and update as it is
						 $sql_up1 = "update files set thumb='".$fetch['thumb']."',thumb_big='".$fetch['thumb_big']."',location='".$fetch['location']."', file_name='".$fetch['file_name']."' where id='".$fetch['id']."'"; 

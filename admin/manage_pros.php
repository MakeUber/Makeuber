...
$item = 'Pros';				// table name for query
$page_child = 'add_edit_pros.php';				// table name for query
...
//print_r($chk);die;
 ...
 //$sql_user = "select * from user where id='$usr' and status='0'"; 
          ...
          <table width="100%" cellspacing="0" border="0" cellpadding="0"  class="maintbl" >
            ...
            <tr class="scndrow <?php echo $z%2 ? '' : 'alternate';?>">
              ...
              <td align="left"><?php echo $fetch['email_id']; ?></td>
                ...
                <?php }?></td>
              <td align="center"><a style="margin:0px 10px;" href="view_pros.php?id=<?php echo $fetch['id'].$q_string_pg; ?>" title="View"> <img src="images/view.png" /> </a> <a style="margin:0px 10px;" href="<?php echo $page_child; ?>?do=edit&id=<?php echo $fetch['id'].$q_string_pg; ?>" title="Edit"> <img src="images/edit.png" /> </a> <a style="margin:0px 10px;" href="<?php echo $namep.'?do=delete&id='.$fetch['id'].$q_string_pg;?>" title="Delete" onclick="return del_fun();"> <img src="images/delete.png" /> </a></td>
            </tr>
            <?php $z++; } ?>
          </table>

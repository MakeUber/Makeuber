        ...
        <form id="add" name="add" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>?5=5<?php echo $q_string; ?>" enctype="multipart/form-data" onsubmit="return check_validation();">
          <table width="100%" border="0" cellpadding="5">
            ...
            <tr>
              ...
              <td>
                  <div style="float:left;"><input name="pic[]" id="location" type="file"  /></div>
                  <div style="float:left;">Description : &nbsp;</div><div style="float:left;"><textarea  id="description" name="description" class="edit2"><?php echo $desc;?> </textarea></div>
              </td>
            </tr>
        	 <?php }?>
                 ...
                 if(counter >= limit){
                  alert("Error: Maximium 10 images upload ");
                    ...
                    var newdiv = document.createElement('div');
                     newdiv.innerHTML = "<div style='margin-left: 206px;padding-top: 5px;padding-right: 14px;float:left;width: 870px;' ><div style='text-align:right'>Image" + (counter + 1)+":&nbsp;&nbsp;" + "<div style='float:right; margin-right:409px;'>&nbsp;&nbsp;&nbsp;&nbsp;<input type='file' id='location' name='pic[]' value='<?php echo $dvar['pic']; ?>' class='edit2'></div></div> <br class='clear'>";
                 ...
                 if(counter1 >= limit1){
                  alert("Error: Maximium 10 descriptions can upload ");
					 ...
					 var newdiv1 = document.createElement('div');
					  newdiv1.innerHTML = "<div style='padding-top: 5px;padding-right: 82px;float:right;'><div style='text-align:left'>Description" + (counter1 + 1)+":&nbsp;" + "</div><textarea  name='description[]' id='description' class='edit2' style='margin-left: 114px;'></textarea></div> <br class='clear'>";

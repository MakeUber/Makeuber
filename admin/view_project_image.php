...
$query_string = array("search" => $_GET['search'], "page" => $_GET['page'], "rel_id" => $_GET['rel_id'], "do" => $_GET['do'], "id" => $_GET['image_id']);
  ...
  <div class="container">
    ...
    <div class="content">
      <div class="viewform">
         ...
         <table width="1150" border="0" cellpadding="5">
          ...
          <tr>
            <td align="right" class="label_form"><div class="view1">Project Name :</div></td>
         	<td><div class="view2"><?php echo $dvar['image_name']; ?></div></td>
         </tr>
         <tr>
       ...
       <tr>
              <td align="right" class="label_form"><div class="view1">Project Status :</div></td>
              <td><div class="view2">
                  <?php 

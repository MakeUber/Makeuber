...
if($_POST['submitbut'] == 'Save'){
	...
	$fetch_user = "select email from $tabl where email='".$dvar['email']."' AND id<>'".$id."'";
	...
	if(!empty($flag)){
		...
		if($_GET['do'] == 'edit'){
			...
			if($password == ''){
				$add_dvar = array('time' => time() ,'password' => $dvar['password']);
			}
			else{
				$add_dvar = array('time' => time() ,'password' => $password );
			}
...
//			$change_dvar = array('status' => '0');
			...
			$add_dvar = array('password' => $password ,'time' => time(),'uniq' => $uniq);
			$remove_dvar = array('image_delete','c_password');
           ...
           <table width="100%" border="0" cellpadding="5">
            <tr>
             ...
             <tr>
               ...
               <td>&nbsp;</td>
               <td scope="col"><input name="email" class="input_text" type="text" value="<?php echo $dvar['email']; ?>" /></td>
             </tr>
             
              <tr>
               <td scope="col" align="right" class="label_form">Sex<span class="star">*</span> : </td>
               <td>&nbsp;</td>
               <td scope="col"><input name="sex" class="input_text" type="text" value="<?php echo $dvar['sex']; ?>" /></td>
             </tr>
             
              <tr>
               <td scope="col" align="right" class="label_form">DOB <span class="star">*</span> : </td>
               <td>&nbsp;</td>
               <td scope="col"><input name="m" class="input_text" type="text" value="<?php echo $dvar['m']; ?>" />
               <input name="d" class="input_text" type="text" value="<?php echo $dvar['d']; ?>" />
               <input name="y" class="input_text" type="text" value="<?php echo $dvar['y']; ?>" />
               </td>
             </tr>
              ...
              <tr>
               ...
               <td>&nbsp;</td>
               <td scope="col"><textarea name="description" id="description"><?php echo $dvar['description']; ?></textarea>
               </td>
             </tr>

        ...
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>?1=1<?php echo $q_string_pg; ?>" method="post" name="<?php echo $item; ?>">
          ...
          <table width="100%" cellspacing="0" cellpadding="0"  class="maintbl" >
            <tr class="fstrow"  >
              ...
              <td align="left" width="20%">Order No</td>
              <td align="center" width="25%"> Plan </td>
            ...
            <?php
			 ...
			 $plan="select * from membership_type where status='1' and id='".$fetch['plan']."'";
			  $query_plan=mysql_query($plan);
			  $fetch_plan=mysql_fetch_assoc($query_plan);
            ?>
            <tr class="scndrow <?php echo $z%2 ? '' : 'alternate';?>">
              <td><input type='checkbox' name='chk[]' value='<?php echo $fetch['id'] ?>' id='checkme<?php echo $z; ?>' /></td >
              
              <td align="left"><div class="n_1"><?php echo $fetch['id']; ?></div></td>
             
              <td align="center"><div class="n_1"><?php echo $fetch_plan['budget']; ?></div></td>
              ...
              <td align="center">
              	<a style="margin:0px 10px;" href="view_order.php?do=view&id=<?php echo $fetch['id'].$q_string_pg; ?>" title="View"> <img src="images/view.png" /> </a>
